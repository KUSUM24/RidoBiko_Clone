        ...
        <div class="bike-card w-100 justify-content-between">
          ...
          <div class="bike-details">
            ...
            <div class="bike-location">
              ...
              <div>
                Karol Bagh
                <span class="more-locations"data-toggle="modal"
        data-target="#locationModal"> and 3 more locations </span>
              </div>
            </div>
          </div>
            ...
            <div class="location-list" id="location-list">
              <div class="location-item-main">
                ...
                <div class="location-btn-main">
                  <div class="location-rent">₹ 1325</div>
                  <div class="location-btn book-now">Book Now</div>
                </div>
              </div>
              <div class="location-item-main">
                <div class="location-item">
