    ...
    <div class="bookings-main flex-column h-100"  id="main-right-0">
      ...
      <div class="card-body">
        <div class="card">
          ...
          <div class="booking-card-main flex flex-column" id="booking-history-main"> 
            <div class="booking-card mt-3 mx-3 card d-flex flex-column ">
              ...
              <div class="d-flex justify-content-center"  >
                <div class="card view-details-section" id="view-details-1" >
                  <div class="card-body">
                    <div class="card-text">
                      Booking Details
                    </div>
          ...
          <div class="booking-card-main flex flex-column" id="subcription-history-main"> 
            <div class="booking-card mt-3 mx-3 card d-flex flex-column ">
              <div class="d-flex justify-content-end">
                <div class="py-2">
                  BOOKING STATUS: <span class="booking-status booking-confirm px-1"> <b> CONFIRM </b></span>
              ...
              <div class="d-flex flex-column align-items-center"  >
                <div class="card view-details-section" id="subscription-details-1" >
                  <div class="card-body">
                    <div class="card-text">
                      Booking Details
                    </div>
